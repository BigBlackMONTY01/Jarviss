...
module.exports = { 
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2349126489199",
    ...
    STICKER_PACKNAME: process.env.STICKER_PACKNAME || "stickers by monte",
    STICKER_AUTHOR: process.env.STICKER_AUTHOR || "🤍",
    BOT_PRESENCE: process.env.BOT_PRESENCE || "available",
    REACT: process.env.REACT || false,
    READ_MESSAGE: process.env.READ_MESSAGE || "false",
    OWNER_NAME: process.env.OWNER_NAME || "Monty",
    ...
    AUDIO_DATA: process.env.AUDIO_DATA || "Monty;🤍",
